...
#define INP_LEN_ERROR_MSG "The input text must be the length of 64-bit (16-bit in hex)."
...
class input_length_not_64_bits: public std::exception { const char* what() const { return INP_LEN_ERROR_MSG; } };
...
const int F_function_S_boxes[8][64] = {
	{
